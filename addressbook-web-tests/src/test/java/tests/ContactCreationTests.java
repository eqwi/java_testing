...
public class ContactCreationTests extends TestBase {
    ...
    public void testContactCreation() {
        ...
        ContactData newContact = new ContactData()
                ...
                .withCompany("New Company").withAddress("spb").withHomePhone("8915196819").withMobilePhone("89456123").withWorkPhone("8989898")
                .withEmail("name.mid.surname@newcompany.ru").withEmail2("2222@qaad.ru").withEmail3("dsaf@124");
